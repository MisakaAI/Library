...
# 找最大文件并排除目录
def find_largest_images_exclude_dirs(path, n, exclude_dirs=[]):
    path = Path(path)
    image_list = []
...
largest_images_paths = find_largest_images_exclude_dirs(directory, n, exclude_dirs=exclude_directories)
